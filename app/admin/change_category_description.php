...
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST["newdesc"])) {
...
<head>
    ...
    <title>Change category description - Administration - Cortex 98</title>
</head>
...
<body class="singleton-dialog">
    <center>
        <?= HeaderBar() ?>
        <?= NavigationBar() ?>
        <p>Please enter a new description for the category, then click <b>Update</b>.</p>
        <form action="" method="POST">
            <table width="300">
                <tr>
                    <td valign="top"><b>New description:</b></td>
                    <td align="right"><textarea name="newdesc" rows="4"></textarea></td>
                </tr>
                <tr>
                    <td>
                        <br>
